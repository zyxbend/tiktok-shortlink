...
public interface ShortLinkActualRemoteService {
    ...
    void saveRecycleBin(@RequestBody ShortLinkRecycleBinSaveReqDTO requestParam);
    ...
    void recoverRecycleBin(@RequestBody ShortLinkRecycleBinRecoverReqDTO requestParam);
    ...
    void removeRecycleBin(@RequestBody ShortLinkRecycleBinRemoveReqDTO requestParam);
